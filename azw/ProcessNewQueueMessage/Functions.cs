...
namespace ProcessNewQueueMessage
{
    ...
    public class Functions
    {
        ...
        public static void QueueToBlob(
            ...
            [QueueTrigger("orders")] Order orders,
            IBinder binder)
        {
            TextWriter writer = binder.Bind<TextWriter>(new BlobAttribute("orders/" + orders.OrderId));
        ...
        public static void PropertyBinding(
            ...
            string Name, int dequeueCount, TextWriter log)
        {

            var json = JsonConvert.SerializeObject(initialorder);
        ...
        public static void FailAlways(
            ...
            int dequeueCount, TextWriter log)
        {
        ...
        /// </summary>
        public static void BindToPoisonQueue(
            [QueueTrigger("badqueue-poison")] string message, 
            TextWriter log)
        {
